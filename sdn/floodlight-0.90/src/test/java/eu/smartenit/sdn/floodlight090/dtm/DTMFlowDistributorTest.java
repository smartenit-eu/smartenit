...
public class DTMFlowDistributorTest {
    ...
    /**
     * Test algorithm ({@link DTM#getgetReactiveWithReferenceOutOfPortNumber()}
     * method).
     *
     * @throws java.util.concurrent.TimeoutException
     */
    @Test
    public void testGetReactiveWithReferenceOutOfPortNumber() throws TimeoutException {
    ...
    public void testGetProactiveWithoutReferenceOutOfPortNumber() {
        ...
        NetworkAddressIPv4 IP = new NetworkAddressIPv4();
        IP.setPrefix("10.10.1.0");
        IP.setPrefixLength(24);
        ...
        dtm.setCompensationVector(FlowDistributorSetUpHelper.C_VECTOR_11);
        dcPrefixOutOfPortMap.put(IP, (short) 1);
        assertEquals(dcPrefixOutOfPortMap, dtm.getProactiveOutOfPortNumber());

        dtm.setCompensationVector(FlowDistributorSetUpHelper.C_VECTOR_21);
        dcPrefixOutOfPortMap.put(IP, (short) 2);
        assertEquals(dcPrefixOutOfPortMap, dtm.getProactiveOutOfPortNumber());

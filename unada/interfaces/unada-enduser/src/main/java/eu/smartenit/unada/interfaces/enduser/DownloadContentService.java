...
/**
 * The download REST API of uNaDa.
 * It listens to URL: http://<unada-ip-address>:<unada-port>/unada/rest/download/<contentID>
 * to download a specific video with contentID.
 *
...
public class DownloadContentService {
	...
	public boolean download(@PathParam("contentID") String contentID) {
        ...
        VimeoDownloader vim = new VimeoDownloader("https://vimeo.com/" + contentID, false);
        try {

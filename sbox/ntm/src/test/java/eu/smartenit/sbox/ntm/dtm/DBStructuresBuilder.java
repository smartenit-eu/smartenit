...
public class DBStructuresBuilder {
	...
	static { 
		DC2DCCommunicationID id1 = new DC2DCCommunicationID(1, "", 2, "", 1, "");
		DC2DCCommunicationID id2 = new DC2DCCommunicationID(2, "", 2, "", 1, "");
		DC2DCCommunicationID id3 = new DC2DCCommunicationID(3, "", 2, "", 1, "");

		SDNController controller1 = new SDNController(null, null, new NetworkAddressIPv4("1.1.1.1", 32), 30, null, 40);
		SDNController controller2 = new SDNController(null, null, new NetworkAddressIPv4("1.1.1.2", 32), 50, null, 60);

		AS localAS = new AS();
		localAS.setAsNumber(2);
		localAS.setLocal(true);
		CloudDC localCloud1 = new CloudDC("", localAS, null, controller1, null);
		CloudDC localCloud2 = new CloudDC("", localAS, null, controller2, null);

		AS remoteAS = new AS();
		remoteAS.setAsNumber(1);
		...
		DC2DCCommunication communication2 = new DC2DCCommunication(id2, Direction.incomingTraffic, remoteCloud, localCloud1, null, null);
		DC2DCCommunication communication3 = new DC2DCCommunication(id3, Direction.outcomingTraffic, remoteCloud, localCloud2, null, null);

		communicationsOnTrafficSender = new ArrayList<DC2DCCommunication>(Arrays.asList(communication1, communication2, communication3));
	}

...
/**
 * Used to store two related vector objects ({@link XVector} and {@link RVector}) 
...
public class XRVectorPair {
	 ...
	 *            reference vector
	 */
	public XRVectorPair(XVector xVector, RVector rVector) {
	...
	public void setRVector(RVector rVector) {
		this.rVector = rVector;
	}
	
	/**
	 * Checks whether both vectors comprising the pair were already set.
	 * 

...
public class DTMTrafficManager {
	 ...
	 */
	public void updateRVector(RVector rVector) throws IllegalArgumentException {
		validate(rVector);
	...
	private void validate(Vector vector) throws IllegalArgumentException {
	...
	private void calculateCompensationVector(VectorProcessingThread thread) {

...
public class SDNControllerContainer {
	...
	private Map<Integer, List<SDNController>> remoteASControllers = new HashMap<Integer, List<SDNController>>();
	 ...
	 */
	public List<SDNController> getControllersByRemoteASNumber(int asNumber) {
	 ...
	 */
	public List<SDNController> getAllControllers() {
		List<SDNController> allControllers = new ArrayList<SDNController>();
	...
	private void createAndPutNewEntry(int asNumber, SDNController controller) {
		remoteASControllers.put(asNumber, new ArrayList<SDNController>(Arrays.asList(controller)));
	}

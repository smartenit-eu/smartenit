...
public class QoSAnalyzerToNetworkTrafficSenderWith95thPercentileValuesTest {
	
	private static final Logger logger = LoggerFactory.getLogger(QoSAnalyzerToNetworkTrafficSenderWith95thPercentileValuesTest.class);	
	...
	private void verifyAllCVectorUpdates(ArgumentCaptor<CVector> cVectorArgument1) {
		...
		assertEquals(-405, cVectorArgument1.getAllValues().get(6).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(405, cVectorArgument1.getAllValues().get(6).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-1132, cVectorArgument1.getAllValues().get(7).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(1132, cVectorArgument1.getAllValues().get(7).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		...
		assertEquals(-1033, cVectorArgument1.getAllValues().get(9).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(1033, cVectorArgument1.getAllValues().get(9).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-947, cVectorArgument1.getAllValues().get(10).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(947, cVectorArgument1.getAllValues().get(10).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
	...
	private void verifyAllCRVectorUpdates(ArgumentCaptor<CVector> cVectorArgument2, ArgumentCaptor<RVector> rVectorArgument) {
		...
		assertEquals(20000, rVectorArgument.getAllValues().get(1).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(20000, rVectorArgument.getAllValues().get(1).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
	}

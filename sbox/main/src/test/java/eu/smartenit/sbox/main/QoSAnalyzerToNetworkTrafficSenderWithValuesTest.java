...
public class QoSAnalyzerToNetworkTrafficSenderWithValuesTest {
	
	private static final Logger logger = LoggerFactory.getLogger(QoSAnalyzerToNetworkTrafficSenderWithValuesTest.class);	

...
public class OneRecDCWith95thPercentileTest {
	
	private static final Logger logger = LoggerFactory.getLogger(OneRecDCWith95thPercentileTest.class);	
	 ...
	 * used instead of the real database. The 95th percentile billing rule is
	 * used by the Economic Analyzer.
	 * 
	 ...
	 */
	@Test @Ignore
	public void shouldTestCompleteWorkflowWithGivenValuesAnd95thPercentileChargingRule() throws Exception {
		...
		verify(mockedSDNClient, times(2)).distribute(any(SDNController.class), cVectorArgument2.capture(), rVectorArgument.capture());
	...
	@Test @Ignore
	public void shouldTestCompleteWorkflowWithGivenValuesAnd95thPercentileChargingRuleAndCVectorNotReset() throws Exception {
		
		logger.info("--Testing full chain starting from QOS Analyzer on the traffic receiver side " +
				"up to NTM on the traffic sender side. --");
		
		SBoxProperties.RESET_COMP_VECTOR_AFTER_SAMPLE = false;
		...
		verifyAllCVectorUpdatesNoCVectorReset(cVectorArgument1);
		verifyAllCRVectorUpdatesNoCVectorReset(cVectorArgument2, rVectorArgument);

		SBoxProperties.RESET_COMP_VECTOR_AFTER_SAMPLE = true;
		logger.info("-----------------------------------------------------");
	}
	...
	private void verifyAllCVectorUpdates(ArgumentCaptor<CVector> cVectorArgument1) {
		...
		assertEquals(0, cVectorArgument1.getAllValues().get(2).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(0, cVectorArgument1.getAllValues().get(2).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-41, cVectorArgument1.getAllValues().get(3).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(41, cVectorArgument1.getAllValues().get(3).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(258, cVectorArgument1.getAllValues().get(4).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(-258, cVectorArgument1.getAllValues().get(4).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(0, cVectorArgument1.getAllValues().get(5).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(0, cVectorArgument1.getAllValues().get(5).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		...
		assertEquals(0, cVectorArgument1.getAllValues().get(8).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(0, cVectorArgument1.getAllValues().get(8).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-1070, cVectorArgument1.getAllValues().get(9).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(1070, cVectorArgument1.getAllValues().get(9).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-1047, cVectorArgument1.getAllValues().get(10).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(1047, cVectorArgument1.getAllValues().get(10).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(0, cVectorArgument1.getAllValues().get(11).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(0, cVectorArgument1.getAllValues().get(11).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
	}
	...
	private void verifyAllCRVectorUpdates(ArgumentCaptor<CVector> cVectorArgument2, ArgumentCaptor<RVector> rVectorArgument) {
		...
		assertEquals(14900, rVectorArgument.getAllValues().get(0).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(20700, rVectorArgument.getAllValues().get(0).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		...
		assertEquals(16700, rVectorArgument.getAllValues().get(1).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(12300, rVectorArgument.getAllValues().get(1).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
	}
	
	private void verifyAllCVectorUpdatesNoCVectorReset(ArgumentCaptor<CVector> cVectorArgument1) {
		NetworkAddressIPv4 tunnelEndPrefix1 = new NetworkAddressIPv4("10.1.1.0", 24);
		NetworkAddressIPv4 tunnelEndPrefix2 = new NetworkAddressIPv4("10.1.2.0", 24);
		...
		assertEquals(258, cVectorArgument1.getAllValues().get(4).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(-258, cVectorArgument1.getAllValues().get(4).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(133, cVectorArgument1.getAllValues().get(5).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(-133, cVectorArgument1.getAllValues().get(5).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-475, cVectorArgument1.getAllValues().get(6).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(475, cVectorArgument1.getAllValues().get(6).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-1280, cVectorArgument1.getAllValues().get(7).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(1280, cVectorArgument1.getAllValues().get(7).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		...
		assertEquals(-1047, cVectorArgument1.getAllValues().get(10).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(1047, cVectorArgument1.getAllValues().get(10).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
		assertEquals(-2862, cVectorArgument1.getAllValues().get(11).getVectorValueForTunnelEndPrefix(tunnelEndPrefix1));
		assertEquals(2862, cVectorArgument1.getAllValues().get(11).getVectorValueForTunnelEndPrefix(tunnelEndPrefix2));
	}
	
	private void verifyAllCRVectorUpdatesNoCVectorReset(ArgumentCaptor<CVector> cVectorArgument2, ArgumentCaptor<RVector> rVectorArgument) {
		NetworkAddressIPv4 tunnelEndPrefix1 = new NetworkAddressIPv4("10.1.1.0", 24);
		NetworkAddressIPv4 tunnelEndPrefix2 = new NetworkAddressIPv4("10.1.2.0", 24);
	...
	private void prepareMockForDAOAtNTM(boolean receiver) {
		...
		when(ntmMockedSCPDAO.findLast()).thenReturn(DBStructuresBuilderForMockedDAO.scpWith95thPercentileRule);
		...
		when(ntmMockedTimeDAO.findLast()).thenReturn(DBStructuresBuilderForMockedDAO.tspFor95thPercentileRule);
	...
	private void prepareMockForDAOAtQOA() {
		...
		when(qoaMockedTimeDAO.findLast()).thenReturn(DBStructuresBuilderForMockedDAO.tspFor95thPercentileRule);
		SystemControlParametersDAO qoaMockedSCPDAO = mock(SystemControlParametersDAO.class);
		when(qoaMockedSCPDAO.findLast()).thenReturn(DBStructuresBuilderForMockedDAO.scpWith95thPercentileRule);
	...
	private void prepareMockForDAOAtECA() {
		...
		when(ecaMockedTimeDAO.findLast()).thenReturn(DBStructuresBuilderForMockedDAO.tspFor95thPercentileRule);
		SystemControlParametersDAO ecaMockedSCPDAO = mock(SystemControlParametersDAO.class);
		when(ecaMockedSCPDAO.findLast()).thenReturn(DBStructuresBuilderForMockedDAO.scpWith95thPercentileRule);
